...
function writeZoneNetfiles(payload, log, callback)
{
    ...
    for (nic in payload.add_nics) {
        if (payload.add_nics.hasOwnProperty(nic)) {
            ...
            // backwards compatibility with old ip6 patch
            if (n.ip === undefined && n.ip6 !== undefined) {
              n.ip = n.ip6;
            }
            ...
            for (nic in payload[field]) {
                if (payload[field].hasOwnProperty(nic)) {
                    ...
                    if (field === 'add_nics' && n.ip !== 'dhcp'
                        ...
                        && (n.ip.indexOf('/') === -1 || n.ip6.indexOf('/') === -1))  {
...
function buildNicZonecfg(vmobj, payload)
{
    ...
    // present:
    var nicProperties = ['ip', 'ip6', 'netmask', 'model', 'dhcp_server',
